...
X1, y1 = make_regression(n_features=Nfeatures, n_informative=1, n_samples=1000,
                         random_state=None, shuffle=False)
X2, y2 = make_regression(n_features=Nfeatures, n_informative=1, n_samples=1000,
                         random_state=None, shuffle=False)
X3, y3 = make_regression(n_features=Nfeatures, n_informative=1, n_samples=1000,
                         random_state=None, shuffle=False)
print(X1.shape)
print(np.hstack(X1, 
